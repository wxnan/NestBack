      ...
      child: Column(
        ...
        children: [
          ...
          ListTile(
            ...
            subtitle: const Text('物品列表，可用 Excel 打开查看'),
            trailing: const Icon(Icons.chevron_right),
          ...
          ListTile(
            ...
            subtitle: const Text('完整数据和图片，适合备份迁移'),
            trailing: const Icon(Icons.chevron_right),
      ...
      child: Column(
        ...
        children: [
          ...
          ListTile(
            ...
            subtitle: const Text('从 JSON 文件恢复完整数据'),
            trailing: const Icon(Icons.chevron_right),
          ...
          ListTile(
            ...
            subtitle: const Text('从 CSV 文件导入添加物品'),
            trailing: const Icon(Icons.chevron_right),
